...
@Component({
  selector: 'app-linked-dtail',
  templateUrl: './linked-dtail.component.html',
  styleUrls: ['./linked-dtail.component.css']
})
export class LinkedDtailComponent implements OnInit {
  ...
  // Userstatus="Active"
  Reasons = [
    {id: 1, name: 'User requested'}, {id: 2, name: 'User verification date invalid'}, {id: 3, name: 'Misuse linked account'},
     {id: 4, name: 'Suspected ticket trading'},
  ];
  relation = [
...
if(this.Userstatus=="Deactivate")
{
  ...
  create() {
    this.form = this.formBuilder.group({
      ...
      dobdd: [null, Validators.required],
      dobmm: [null, Validators.required],
      dobyy: [null, Validators.required],
  ...
  onSubmit() {
    ...
    // /auth/signup/additional
    // this.router.navigate(['/profile/create1']);
  }
